...
CATEGORIES = {
    "producto": {
        "analysis.c", "array.c", "arrow_ipc.c", "canonical_compiler.c", "canonical_ir.c", "typed_bytecode.c", "common.c", "dataset.c", "entrypoints.c", "finance.c",
