...
CATEGORIES = {
    "producto": {
        "analysis.c", "array.c", "arrow_ipc.c", "canonical_compiler.c", "common.c", "dataset.c", "entrypoints.c", "finance.c",
        ...
        "sst_report_advanced.c", "sst_stats.c", "stream.c", "source_reader.c", "group_key_codec.c", "table.c",
    },
    "lenguaje": {
