...
CATEGORIES = {
    "producto": {
        ...
        "script.c", "interpreter.c", "partition_executor.c", "partition_plan.c", "partition_reduce.c", "partition_protocol.c", "partition_protocol_reduce.c", "process_executor.c", "sst_advanced.c", "sst_contingency.c", "sst_correlation.c",
