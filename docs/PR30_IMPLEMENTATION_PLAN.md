...
|---|---|---|---|
| 0 | Integración y auditoría de PR #29 sobre `main` | Planner único, contratos preservados, CI del head exacto aprobada y límites registrados con evidencia. | En curso; hay fallos del primer CI corregidos y el head corregido requiere nueva validación completa. |
| 1 | Fase 3 — fuentes columnares y ORM SQL | Una lectura/escritura columnar local end-to-end y una vertical SQL tipada end-to-end, ambas desde el lenguaje y con pruebas. | Pendiente del gate funcional de Etapa 0. |
