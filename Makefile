...
tests/test_stream: tests/test_stream.c src/stream.c src/source_reader.c src/group_key_codec.c src/grouped_aggregate.c src/mergeable_aggregate.c src/spill_store.c src/common.c
	$(CC) $(CFLAGS) tests/test_stream.c src/stream.c src/source_reader.c src/group_key_codec.c src/grouped_aggregate.c src/mergeable_aggregate.c src/spill_store.c src/common.c $(LDFLAGS) -o $@
