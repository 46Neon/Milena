...
.PHONY: test-bytecode test-bytecode-compiler
...
# Portable experimental bytecode slice: never added to the production source list.
test-bytecode: tests/test_bytecode tests/test_bytecode_compiler
	./tests/test_bytecode
...
BYTECODE_COMPILER_TEST_SOURCES = src/bytecode_compiler.c src/bytecode.c \
