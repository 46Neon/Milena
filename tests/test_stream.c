...
static void test_grouped_spill(void) {
    ...
    assert(p != NULL); memmove(p + strlen("\"derramado\":") + 4, p + strlen("\"derramado\":") + 5, strlen(p + strlen("\"derramado\":") + 5) + 1); memcpy(p + strlen("\"derramado\":"), "true", 4);
    ...
    memmove(p + strlen("\"derramado\":") + 4, p + strlen("\"derramado\":") + 5, strlen(p + strlen("\"derramado\":") + 5) + 1); memcpy(p + strlen("\"derramado\":"), "true", 4);
